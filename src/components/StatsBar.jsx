...
function StatCard({ item }) {
  return (
    <article className="overflow-hidden rounded-[1.6rem] border border-brand-line bg-white shadow-[0_18px_48px_rgba(6,34,75,0.10)]">
...
export function StatsBar({ stats }) {
  return (
    <section id="confianza" className="relative scroll-mt-28 bg-[linear-gradient(180deg,#eef3f8_0%,#f8fafc_100%)] py-20">
      <Container>
        <SectionHeading
        ...
        />
        <div className="mt-10 rounded-[2rem] border border-brand-line bg-gradient-to-br from-white via-brand-porcelain to-white p-4 shadow-premium xl:p-5">
