  ...
  return (
    <header className="sticky left-0 right-0 top-0 z-40 w-full max-w-full overflow-hidden border-b border-brand-silver/70 bg-[linear-gradient(90deg,#f7f9fc_0%,#ffffff_46%,#e8eef5_100%)] shadow-[0_16px_42px_rgba(6,34,75,0.16)]">
      <div
        ...
        aria-hidden="true"
      />
      <Container className="relative px-4 py-2.5 sm:px-6 lg:px-8">
        <div className="flex min-w-0 items-center justify-between gap-3 sm:gap-4">
          <a
            href="#inicio"
            title="Volver al inicio"
            className="group min-w-0 max-w-[9.75rem] flex-1 rounded-2xl transition hover:-translate-y-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-green focus-visible:ring-offset-2 focus-visible:ring-offset-white min-[390px]:max-w-[11.5rem] sm:max-w-[17rem] lg:flex-none"
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="shrink-0 rounded-full bg-[#25D366] px-3 py-3 text-sm font-extrabold text-white shadow-[0_18px_40px_rgba(37,211,102,0.35)] transition hover:-translate-y-0.5 hover:bg-[#1fbe59] sm:px-5"
          >
