export function BrandLogo() {
  return (
    <div className="flex w-full min-w-0 items-center">
      ...
      <div className="hidden overflow-hidden rounded-xl bg-brand-ink p-1 shadow-[0_10px_24px_rgba(6,34,75,0.18)] transition group-hover:shadow-[0_14px_30px_rgba(6,34,75,0.24)] sm:block">
        <img
