  ...
  return (
    <article className="group rounded-[1.8rem] border border-brand-silver/20 bg-white p-7 shadow-card transition duration-300 hover:-translate-y-1 hover:border-brand-green/45 hover:shadow-premium">
      <div className="flex items-start justify-between gap-4">
        <div className={`inline-flex h-12 min-w-12 items-center justify-center rounded-2xl px-4 font-display text-lg font-bold text-white shadow-[0_12px_26px_rgba(6,34,75,0.16)] ${accent}`}>
          0{index + 1}
        </div>
