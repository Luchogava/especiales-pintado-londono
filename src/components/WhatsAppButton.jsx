export function WhatsAppButton({ href }) {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[linear-gradient(135deg,#25D366_0%,#74C043_100%)] text-white ring-[5px] ring-white shadow-[0_22px_45px_rgba(37,211,102,0.48)] transition hover:-translate-y-1 hover:scale-105 focus:outline-none focus-visible:ring-brand-green sm:bottom-5 sm:right-5 sm:h-16 sm:w-16"
    >
