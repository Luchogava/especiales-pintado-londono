        ...
        <div className="rounded-[2rem] border border-brand-silver/12 bg-[linear-gradient(135deg,#040b16_0%,#06224b_58%,#0c1930_100%)] px-6 py-8 text-white shadow-[0_20px_50px_rgba(5,26,52,0.24)] sm:px-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              <p className="text-sm font-extrabold uppercase tracking-[0.22em] text-brand-green">Hablemos de tu servicio</p>
              <h2 className="mt-3 font-display text-3xl font-bold sm:text-4xl">
                Ya conoces nuestros servicios y respaldos. Ahora elige cómo quieres contactarnos.
              </h2>
              <p className="mt-4 text-lg leading-8 text-slate-300">
                Puedes escribirnos por WhatsApp para una respuesta ágil o pasar directo al formulario de cotización.
              </p>
            </div>
